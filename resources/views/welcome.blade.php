...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        @auth
                            ...
                            <li class="nav-item">
                                <a href="{{ route('truck-out.index') }}" class="nav-link">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Terminal Management System</h1>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-12">
                            <div class="card card-primary card-outline">
                                <div class="card-header">
                                    <h3 class="card-title">Welcome to TMS</h3>
                                </div>
                                <div class="card-body">
                                    @auth
                                    ...
                                    @else
                                        <p>Welcome to the Terminal Management System. Please login or register to continue.</p>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2025 <a href="#">Terminal Management System</a>.</strong>
            All rights reserved.
        </footer>
    </div>
